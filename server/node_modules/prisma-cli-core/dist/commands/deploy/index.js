...
var Deploy = /** @class */ (function (_super) {
    ...
    Deploy.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var _a, force, watch, interactive, envFile, dryRun, serviceName, stage, workspace, cluster, dockerComposeYml, endpointDialog, results, _b, dockerComposeInstalled, projectNew;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        if (!(!serviceName || !stage || interactive)) return [3 /*break*/, 5];
                    ...
                    case 8:
                        if (!(_b &&
                            !fs.readdirSync(this.config.definitionDir).includes('docker-compose.yml'))) return [3 /*break*/, 10];
                        fs.writeFileSync(path.join(this.config.definitionDir, 'docker-compose.yml'), dockerComposeYml);
                        this.out.log("Created docker-compose.yml with a local prisma server.\nPlease run " + chalk_1.default.cyan('$ docker-compose up -d') + " to start your local prisma.\nNote: prisma local start will be deprecated soon in favor of the direct usage of docker-compose.");
                        return [4 /*yield*/, dockerComposeInstalled_1.isDockerComposeInstalled()];
                    case 9:
                        dockerComposeInstalled = _c.sent();
                        if (!dockerComposeInstalled) {
                            this.out.log("To install docker-compose, please follow this link: " + chalk_1.default.cyan('https://docs.docker.com/compose/install/'));
                        }
                        process.exit(1);
                        _c.label = 10;
                    case 10:
                        if (!(this.definition.definition.cluster && !cluster)) return [3 /*break*/, 12];
                    ...
                    case 12:
                        ...
                        if (!(cluster && !cluster.local && cluster.isPrivate)) return [3 /*break*/, 14];
                        if (!workspace) {
                            workspace = this.definition.getWorkspace() || '*';
                        }
                        if (!(workspace &&
                            !workspace.startsWith('public-') &&
                            (!this.env.cloudSessionKey || this.env.cloudSessionKey === ''))) return [3 /*break*/, 14];
                        return [4 /*yield*/, this.client.login()];
                    case 13:
                        _c.sent();
                        cluster.clusterSecret = this.env.cloudSessionKey;
                        _c.label = 14;
                    case 14: return [4 /*yield*/, this.client.initClusterClient(cluster, serviceName, stage, workspace)];
                    case 15:
                        _c.sent();
                    ...
                    case 18:
                        ...
                        projectNew = true;
                        _c.label = 19;
                    case 19: return [4 /*yield*/, this.deploy(stage, serviceName, cluster, cluster.name, force, dryRun, projectNew, workspace)];
                    case 20:
                        _c.sent();
                        if (watch) {
    ...
    Deploy.prototype.deploy = function (stageName, serviceName, cluster, completeClusterName, force, dryRun, projectNew, workspace) {
        return __awaiter(this, void 0, void 0, function () {
            var localNote, before, b, verb, migrationResult, done, revision, migration, hooks, _i, hooks_1, hook, splittedHook, child, stderr, stdout;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.deploying = true;
