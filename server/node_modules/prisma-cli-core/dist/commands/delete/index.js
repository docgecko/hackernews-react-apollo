            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.client.initClusterClient(cluster, this.definition.getWorkspace() || '*', serviceName, stage)];
                    case 2:
                        _a.sent();
                    ...
                    case 4:
                        before = Date.now();
                        this.out.action.start("" + chalk_1.default.red.bold("Deleting service " + prettyName));
